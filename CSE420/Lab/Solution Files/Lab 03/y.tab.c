...
{
       0,    32,    32,    44,    50,    58,    64,    72,    93,   111,
     129,   135,   146,   154,   164,   176,   188,   195,   202,   211,
     225,   240,   254,   271,   277,   285,   291,   297,   303,   309,
     315,   321,   327,   333,   344,   352,   358,   366,   391,   418,
     424,   445,   451,   464,   470,   483,   489,   505,   511,   539,
     550,   561,   569,   575,   606,   613,   619,   625,   632,   641,
     648,   655,   663
};
#endif
...
#line 73 "23241108+23341130.y"
    {
        ...
        func->set_data_type((yyvsp[(1) - (6)])->get_name());
        ...
        if (sym_table->lookup(func) != nullptr) {
            outerr << "At line no: " << lines << " Multiple declaration of function " << (yyvsp[(2) - (6)])->get_name() << endl;
            error_count++;
        } else {
...
#line 94 "23241108+23341130.y"
    {
        ...
        if (sym_table->lookup(func) != nullptr) {
            outerr << "At line no: " << lines << " Multiple declaration of function " << (yyvsp[(2) - (5)])->get_name() << endl;
            error_count++;
        } else {
            sym_table->insert(func);
        }
...
#line 112 "23241108+23341130.y"
    {
        ...
        symbol_info *param = new symbol_info((yyvsp[(4) - (4)])->get_name(), "ID");
        param->set_symbol_type("Variable");
        param->set_data_type((yyvsp[(3) - (4)])->get_name());
        for (auto p : param_list) {
            if (p->get_name() == (yyvsp[(4) - (4)])->get_name()) {
                outerr << "At line no: " << lines << " Multiple declaration of variable " << (yyvsp[(4) - (4)])->get_name() << " in parameter" << endl;
                error_count++;
                break;
            }
        }
...
#line 136 "23241108+23341130.y"
    {
        ...
        symbol_info *param = new symbol_info((yyvsp[(2) - (2)])->get_name(), "ID");
        param->set_symbol_type("Variable");
        param->set_data_type((yyvsp[(1) - (2)])->get_name());
        param_list.push_back(param);
    }
    break;
...
#line 212 "23241108+23341130.y"
    {
        ...
        if (!sym_table->insert(var)) {
            outerr << "At line no: " << lines << " Multiple declaration of variable " << (yyvsp[(3) - (3)])->get_name() << endl;
            error_count++;
        }
    }
    break;
...
#line 226 "23241108+23341130.y"
    {
        ...
        if (!sym_table->insert(arr)) {
            outerr << "At line no: " << lines << " Multiple declaration of variable " << (yyvsp[(3) - (6)])->get_name() << endl;
            error_count++;
        }
    }
    break;
...
#line 241 "23241108+23341130.y"
    {
        ...
        var->set_data_type(current_type);
        if (!sym_table->insert(var)) {
            outerr << "At line no: " << lines << " Multiple declaration of variable " << (yyvsp[(1) - (1)])->get_name() << endl;
            error_count++;
        }
    }
    break;
...
#line 255 "23241108+23341130.y"
    {
        ...
        if (!sym_table->insert(arr)) {
            outerr << "At line no: " << lines << " Multiple declaration of variable " << (yyvsp[(1) - (4)])->get_name() << endl;
            error_count++;
        }
    }
    break;
...
#line 334 "23241108+23341130.y"
    {
        ...
        if (var == nullptr) {
            outerr << "At line no: " << lines << " Undeclared variable " << (yyvsp[(3) - (5)])->get_name() << endl;
            error_count++;
        }
    }
    break;
...
#line 359 "23241108+23341130.y"
  ...
  case 37:
/* Line 1792 of yacc.c  */
#line 367 "23241108+23341130.y"
    {
        outlog << "At line no: " << lines << " variable : ID " << endl << endl;
        outlog << (yyvsp[(1) - (1)])->get_name() << endl << endl;
        symbol_info* var = sym_table->lookup((yyvsp[(1) - (1)]));
        if (var == nullptr) {
            outerr << "At line no: " << lines << " Undeclared variable: " << (yyvsp[(1) - (1)])->get_name() << endl;
            error_count++;
            (yyval) = new symbol_info((yyvsp[(1) - (1)])->get_name(), "variable");
            (yyval)->set_data_type("undeclared");
        } else if (var->get_symbol_type() == "Function") {
            outerr << "At line no: " << lines << " Function used as variable: " << (yyvsp[(1) - (1)])->get_name() << endl;
            error_count++;
            (yyval) = new symbol_info((yyvsp[(1) - (1)])->get_name(), "variable");
            (yyval)->set_data_type("function");
        } else if (var->get_symbol_type() == "Array") {
            outerr << "At line no: " << lines << " variable is of array type : " << (yyvsp[(1) - (1)])->get_name() << endl;
            error_count++;
            (yyval) = new symbol_info((yyvsp[(1) - (1)])->get_name(), "variable");
  ...
  case 38:
/* Line 1792 of yacc.c  */
#line 392 "23241108+23341130.y"
    {
        outlog << "At line no: " << lines << " variable : ID LTHIRD expression RTHIRD " << endl << endl;
        outlog << (yyvsp[(1) - (4)])->get_name() << "[" << (yyvsp[(3) - (4)])->get_name() << "]" << endl << endl;
        symbol_info* var = sym_table->lookup((yyvsp[(1) - (4)]));
        if (var == nullptr) {
            outerr << "At line no: " << lines << " Undeclared variable: " << (yyvsp[(1) - (4)])->get_name() << endl;
            error_count++;
            (yyval) = new symbol_info((yyvsp[(1) - (4)])->get_name() + "[" + (yyvsp[(3) - (4)])->get_name() + "]", "variable");
            (yyval)->set_data_type("undeclared");
        } else if (var->get_symbol_type() != "Array") {
            outerr << "At line no: " << lines << " variable is not of array type : " << (yyvsp[(1) - (4)])->get_name() << endl;
            error_count++;
            (yyval) = new symbol_info((yyvsp[(1) - (4)])->get_name() + "[" + (yyvsp[(3) - (4)])->get_name() + "]", "variable");
            (yyval)->set_data_type(var->get_data_type());
        } else if ((yyvsp[(3) - (4)])->get_data_type() != "int") {
            outerr << "At line no: " << lines << " array index is not of integer type : " << (yyvsp[(1) - (4)])->get_name() << endl;
            error_count++;
            (yyval) = new symbol_info((yyvsp[(1) - (4)])->get_name() + "[" + (yyvsp[(3) - (4)])->get_name() + "]", "variable");
            (yyval)->set_data_type(var->get_data_type());
        } else {
...
#line 419 "23241108+23341130.y"
  ...
  case 40:
/* Line 1792 of yacc.c  */
#line 425 "23241108+23341130.y"
    {
        outlog << "At line no: " << lines << " expression : variable ASSIGNOP logic_expression " << endl << endl;
        outlog << (yyvsp[(1) - (3)])->get_name() << "=" << (yyvsp[(3) - (3)])->get_name() << endl << endl;
        (yyval) = new symbol_info((yyvsp[(1) - (3)])->get_name() + "=" + (yyvsp[(3) - (3)])->get_name(), "expr");
        if ((yyvsp[(1) - (3)])->get_symbol_type() == "Array") {
            outerr << "At line no: " << lines << " cannot assign to array " << (yyvsp[(1) - (3)])->get_name() << endl;
            error_count++;
        ...
        } else if ((yyvsp[(1) - (3)])->get_data_type() != (yyvsp[(3) - (3)])->get_data_type() && (yyvsp[(1) - (3)])->get_data_type() != "undeclared" && (yyvsp[(3) - (3)])->get_data_type() != "undeclared") {
...
#line 512 "23241108+23341130.y"
    {
        ...
        if ((yyvsp[(1) - (3)])->get_data_type() == "void" || (yyvsp[(3) - (3)])->get_data_type() == "void") {
            ...
            if ((yyvsp[(3) - (3)])->get_type() == "CONST_INT" && (yyvsp[(3) - (3)])->get_name() == "0") {
...
#line 576 "23241108+23341130.y"
    {
        ...
        if (func == nullptr) {
            outerr << "At line no: " << lines << " Undeclared function: " << (yyvsp[(1) - (4)])->get_name() << endl;
            error_count++;
            (yyval)->set_data_type("undeclared");
        } else if (func->get_symbol_type() != "Function") {
            outerr << "At line no: " << lines << " Not a function: " << (yyvsp[(1) - (4)])->get_name() << endl;
            error_count++;
            (yyval)->set_data_type("not_function");
        } else {
            vector<pair<string, string>> params = func->get_parameters();
            vector<string> arg_types = (yyvsp[(3) - (4)])->get_arg_types();
            if (params.size() != arg_types.size()) {
                outerr << "At line no: " << lines << " Inconsistencies in number of arguments in function call: " << (yyvsp[(1) - (4)])->get_name() << endl;
                error_count++;
            } else {
                for (size_t i = 0; i < params.size(); i++) {
                    if (params[i].first != arg_types[i]) {
                        outerr << "At line no: " << lines << " argument " << i+1 << " type mismatch in function call: " << (yyvsp[(1) - (4)])->get_name() << endl;
                        error_count++;
                    }
                }
            }
...
#line 648 "23241108+23341130.y"
  ...
  case 61:
/* Line 1792 of yacc.c  */
#line 656 "23241108+23341130.y"
    {
        outlog << "At line no: " << lines << " arguments : arguments COMMA logic_expression " << endl << endl;
        outlog << (yyvsp[(1) - (3)])->get_name() << "," << (yyvsp[(3) - (3)])->get_name() << endl << endl;
        (yyval) = new symbol_info((yyvsp[(1) - (3)])->get_name() + "," + (yyvsp[(3) - (3)])->get_name(), "arg");
        (yyval)->get_arg_types() = (yyvsp[(1) - (3)])->get_arg_types();
        (yyval)->get_arg_types().push_back((yyvsp[(3) - (3)])->get_data_type());
    }
    break;

  case 62:
/* Line 1792 of yacc.c  */
#line 664 "23241108+23341130.y"
    {
        outlog << "At line no: " << lines << " arguments : logic_expression " << endl << endl;
        outlog << (yyvsp[(1) - (1)])->get_name() << endl << endl;
        (yyval) = new symbol_info((yyvsp[(1) - (1)])->get_name(), "arg");
        (yyval)->get_arg_types().push_back((yyvsp[(1) - (1)])->get_data_type());
    }
    break;
